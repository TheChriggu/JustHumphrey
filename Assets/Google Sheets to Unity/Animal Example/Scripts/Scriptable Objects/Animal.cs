...
{
    //[HideInInspector]
    public string associatedSheet = "1qNRAV6N3w5m75SW7CRzg6GzCEOaZOSkWbYIHX-E-ld4";
    [HideInInspector]
...
public class AnimalEditor : Editor
{
    ...
    {
        ss[animal.name, "Bar"].UpdateCellValue(animal.associatedSheet, animal.associatedWorksheet, animal.health.ToString()); 
    }
}
#endif
